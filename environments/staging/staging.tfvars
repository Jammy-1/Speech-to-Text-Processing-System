...
# Tags
tags = {
  Project     = "Speech-to-Text-Processing-System-Staging"
  Environment = "Staging"
  Owner       = "Dev-Ops"
  CostCenter  = "Speech-to-Text-Processing-System-Staging"
  ManagedBy   = "Platform"
  CreatedDate = "2026-01-17"
}

# Storage
storage_account_name    = "sttprocessingstg"
uai_storage_worker_name = "uai-storage-worker"


# Log Analytics
log_workspace_name = "stt-log-analytics"
storage_log_name   = "storage-logs-stt-stg"

# Key Vault
key_vault_name          = "kv-stt-stg"
...
#Speech
cognitive_account_name     = "stt-cognitive-speech-stg"
speech_subdomain_name      = "stt-speech-stg"
uai_name_cognitive_account = "uai-ca-speech-service"
uai_speech_worker_name     = "uai-speech-worker"

# Search
search_service_name     = "search-service-stt-staging"
...
# Queue / Service Bus
service_bus          = "stt-aks-service-bus-stg"
...
# ACR 
acr_name             = "acrsttprocessingstg"
uai_acr_name         = "acr-uai"
uai_ci_cd_acr_name   = "ci-cd-acr-uai"
api_worker_image     = "myacrprod.azurecr.io/api:stg"
speech_worker_image  = "myacrprod.azurecr.io/speech-worker:stg"
search_worker_image  = "myacrprod.azurecr.io/search-worker:stg"
storage_worker_image = "myacrprod.azurecr.io/storage-worker:stg"

# AKS
kubernetes_cluster_name = "stt-aks-cluster-stg"
